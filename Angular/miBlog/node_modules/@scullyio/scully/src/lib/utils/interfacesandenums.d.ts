...
export declare type RoutesTypes = RouteTypeJson | RouteTypeContentFolder | RouterTypeDefault | RouteTypeUnknown;
export interface RouterTypeDefault {
    type: RouteTypes.default;
    postRenderers?: (string | symbol)[];
}
export declare type RouteTypeJson = {
...
export declare type RouteTypeUnknown = {
    postRenderers?: (string | symbol)[];
    type: string;
} & {
