 ...
 *
 */
export declare const getJsonFile: <T>(tree: Tree, path: string, mode?: JsonParseMode) => T;
export declare const getFileContents: (tree: Tree, filePath: string) => string;
/** Parser of package.json file
 *
 *  Allow only strict json content
 *
 */
export declare const getPackageJson: (tree: Tree, packagejsonPath?: string) => PackageJson;
export declare const overwritePackageJson: (tree: Tree, content: PackageJson, packagejsonPath?: string) => Tree;
export declare function getSourceFile(host: Tree, path: string): SourceFile;
export declare const yamlToJson: (host: Tree, filePath: string) => unknown;
export declare const jsonToJaml: (metaData: {}) => string;
export declare const toAscii: (src: string) => string;
export declare const getProject: (host: Tree, project: string, angularjsonPath?: string) => string;
export declare const getScullyConfig: (host: Tree, project: string) => string;
export declare const checkProjectExist: (host: Tree, project?: string, angularjsonPath?: string) => boolean;
