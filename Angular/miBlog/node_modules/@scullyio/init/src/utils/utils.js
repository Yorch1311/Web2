...
exports.removeWrongCharacters = exports.checkProjectExist = exports.getScullyConfig = exports.getProject = exports.toAscii = exports.jsonToJaml = exports.yamlToJson = exports.getSourceFile = exports.overwritePackageJson = exports.getPackageJson = exports.getFileContents = exports.getJsonFile = exports.parseJsonObject = exports.getStyle = exports.getRoot = exports.getSrc = exports.addRouteToModule = exports.getPrefix = exports.applyWithOverwrite = exports.addTypescriptFolder = exports.addRouteToScullyConfig = void 0;
 ...
 *
 */
const getJsonFile = (tree, path, mode = core_1.JsonParseMode.Json) => {
 ...
 *
 */
const getPackageJson = (tree, packagejsonPath = DEFAULT_PACKAGE_JSON_PATH) => {
    return exports.getJsonFile(tree, packagejsonPath);
};
exports.getPackageJson = getPackageJson;
const overwritePackageJson = (tree, content, packagejsonPath = DEFAULT_PACKAGE_JSON_PATH) => {
...
const yamlToJson = (host, filePath) => {
    ...
    try {
        return js_yaml_1.load(metaDataContents);
    }
    catch (e) {
...
const jsonToJaml = (metaData) => js_yaml_1.dump(metaData);
exports.jsonToJaml = jsonToJaml;
const toAscii = (src) => {
    if (!src) {
        return null;
    }
...
const getProject = (host, project, angularjsonPath = DEFAULT_ANGULAR_CONF_PATH) => {
    let angularJson;
...
const getScullyConfig = (host, project) => {
    const scullyConfigFile = `scully.${exports.getProject(host, project)}.config.ts`;
    return scullyConfigFile;
};
exports.getScullyConfig = getScullyConfig;
const checkProjectExist = (host, project = '', angularjsonPath = DEFAULT_ANGULAR_CONF_PATH) => {
    let angularJson;
    try {
        angularJson = parseJsonObject(host.read(angularjsonPath).toString());
    }
...
const removeWrongCharacters = (str) => {
    return str.replace(/\{|\}|\(|\)|\;/g, '');
};
exports.removeWrongCharacters = removeWrongCharacters;
